...
public class MemoryExtractionService {
    ...
    public MemoryExtractionService(DashScopeChatModel dashScopeChatModel, VectorStore vectorStore) {
        this.extractClient = ChatClient.builder(dashScopeChatModel).build();
    ...
    public void extractAndStore(String userId, String taskSummary) {
        ...
        String extraction = extractClient.prompt()
                .system("""
