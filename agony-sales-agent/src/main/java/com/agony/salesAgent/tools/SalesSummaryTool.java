...
public class SalesSummaryTool {
    ...
    public String getTopReps(
        ...
        try {
            ...
            int limit = Math.clamp(topN, 1, 50);

            List<RepSalesDTO> reps = queryService.queryRepRanking(start, end, limit);
            if (reps.isEmpty()) {
                return "该时段内暂无销售数据";
            }
    ...
    public String getRegionRanking(
        ...
        try {
            ...
            for (int i = 0; i < regions.size(); i++) {
                ...
                double ratio = grandTotal.compareTo(region.totalAmount()) > 0
    ...
    public String getTopProducts(
        ...
        try {
            ...
            int n = Math.clamp(Math.abs(topN), 1, 20);
