...
public class SalesQueryTool {
    ...
    public String queryOrders(
        ...
        try {
            ...
            if (orders.isEmpty()) {
                return String.format("在 %s 至 %s 期间，%s暂无订单",
                        startDate, endDate,
            ...
            List<SalesOrder> limited = orders.size() > actualLimit ? orders.subList(0, actualLimit) : orders;
    ...
    private String formatOrders(List<SalesOrder> orders, int total,
        ...
        sb.append(String.format("共查询到 %d 条订单", total));
