...
import com.agony.springai.repository.OrderRepository;
import com.agony.springai.repository.ProductRepository;
...
public class OrderQueryTools {
    ...
    public OrderQueryTools(OrderRepository orderRepository, ProductRepository productRepository) {
    ...
    public String getUserOrders(
        ...
        List<Order> orders = orderRepository.findByUserIdOrderByCreatedAtDesc(userId, PageRequest.of(0, safeLimit));
