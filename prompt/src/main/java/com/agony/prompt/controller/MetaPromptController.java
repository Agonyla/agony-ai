...
public class MetaPromptController {
    ...
    public MetaPromptController(DashScopeChatModel dashScopeChatModel) {
    ...
    public String generatePrompt(@RequestParam String scenario) {
        ...
        return chatClient.prompt()
                .system(META_PROMPT)
                .user("请为以下场景生成 System Prompt：\n\n" + scenario)
                .call()
                .content();
    }

    @PostMapping("/optimize")
    public PromptOptimizationResult optimizePrompt(@RequestBody PromptOptimizationRequest request) {
        ...
        String content = String.format("""
                ...
                %s
                """, request.currentPrompt(), request.expectedTask(), request.issues(), converter.getFormat());

        String raw = chatClient.prompt()
                .system(OPTIMIZE_META_PROMPT)
                .user(content)
                .call()
                .content();
